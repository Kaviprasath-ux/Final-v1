...
import styles from './HotelFooter.module.css';
...
const footerSections = [
  ...
  },
  {
    ...
    links: ['Pre-Check-In', 'AI Assistant', 'Room Service', 'Concierge']
  },
  {
    title: 'Support',
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <div className={styles.footerBrand}>
            <h3>LUXURY HOTEL</h3>
            <p>Redefining hospitality with AI-powered experiences</p>
            ...
            >
              <Sparkles size={16} />
              <span>Powered by <strong>Glimmora AI</strong></span>
            </motion.div>
